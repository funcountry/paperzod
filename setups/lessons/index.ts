...
const lessonsSeed = {
  ...
  surfaceSections: [
    ...
    {
      id: "packet_shape_section",
      surfaceId: "packet_shapes_standard",
      stableSlug: "packet-shape",
      title: "Packet Shape",
      body: [
    ...
    {
      id: "quality_bar_section",
      surfaceId: "quality_bar_standard",
      stableSlug: "quality-bar",
      title: "Quality Bar",
      body: [
    ...
    {
      id: "github_protocol_section",
      surfaceId: "github_protocol_surface",
      stableSlug: "github-access",
      title: "GitHub Access",
      body: [
    ...
    {
      id: "mobile_bootstrap_section",
      surfaceId: "mobile_bootstrap_surface",
      stableSlug: "bootstrap",
      title: "Bootstrap",
      body: [
