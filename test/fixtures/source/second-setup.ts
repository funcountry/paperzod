import { defineSetup, defineWorkflowStep } from "../../../src/source/index.js";
import { sharedRole } from "./shared-overrides.js";

const secondSetupSeed = defineSetup({
  id: "core_dev",
  name: "Core Dev",
  description: "A non-Lessons proving fixture for a different Paperclip setup.",
  roles: [
    {
      ...sharedRole,
  ...
  surfaceSections: [
    ...
    { id: "shared_release_order", surfaceId: "core_dev_readme", stableSlug: "release-order", title: "Release Order" },
